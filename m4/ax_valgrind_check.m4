...
#   each of the available Valgrind tools (out of memcheck, helgrind, drd),
#   and will output results to test-suite-$toolname.log for each.
...
#    memcheck, helgrind, drd). (Default: various)
