...
static void checker_select(struct chk *checker, const uint8_t *data, size_t len)
{
	...
	case pc_2ed_012_10_case08:
		if (chk->state == 0) {
			if ((len == 8) &&
			    (!memcmp(data, "\xB0\x00\x00\x00\x01\x01\x01\x02",
									    8)))
				chk->state = 1;
		}
		break;
	...
	case pc_2ed_018_00_case02:
	case pc_2ed_018_00_case03:
		if (chk->state == 0) {
			if ((len == 16) &&
			    (!memcmp(data, "\xA0\x00\x00\x00\x03\x00\x03\x01"
				       "\x02\x03\x04\x05\x06\x07\x08\x09", 16)))
	...
	case pc_2ed_018_00_case04:
		if (chk->state == 0) {
			if ((len == 9) &&
			    (!memcmp(data, "\xB0\x00\x00\x00\x01\x01\x01\x11"
								    "\x22", 9)))
				chk->state = 1;
		}
		break;

	case pc_2ed_018_00_case05:
		if (chk->state == 0) {
			if ((len == 16) &&
			    (!memcmp(data, "\xA0\x00\x00\x00\x04\x00\x04\x01"
				       "\x02\x03\x04\x05\x06\x07\x08\x09", 16)))
...
static void checker_gpo_data(struct chk *checker, struct tlv *data)
{
	...
	case pc_2ea_017_01:
		...
		if (!check_value(chk, data, EMV_ID_FCI_TEMPLATE,
			  "\x84\x07\xA0\x00\x00\x00\x03\x00\x03\xA5\x16\x50\x04"
			  "\x41\x50\x50\x33\x87\x01\x01\x9F\x38\x0A\xD1\x02\x9F"
					  "\x66\x04\x9F\x2A\x08\x6F\x23", 33) ||
		...
		if (chk->state == 2) {
			if (!check_value(chk, data, EMV_ID_KERNEL_IDENTIFIER,
			    ...
			    !check_value(chk, data, EMV_ID_FCI_TEMPLATE,
				  "\x84\x07\xA0\x00\x00\x00\x03\x00\x03\xA5\x16"
				  "\x50\x04\x41\x50\x50\x33\x87\x01\x01\x9F\x38"
				 "\x0A\xD1\x02\x9F\x66\x04\x9F\x2A\x08\x6F\x23",
									    33))
				chk->pass_criteria_met = false;
			chk->pass_criteria_checked = true;
		}
	...
	case pc_2ed_001_00_case06:
		if (chk->state == 2) {
			if (!check_value(chk, data, EMV_ID_KERNEL_IDENTIFIER,
								   "\x23", 1) ||
			    !check_value(chk, data, EMV_ID_FCI_TEMPLATE,
				  "\x84\x07\xA0\x00\x00\x00\x01\x00\x01\xA5\x16"
				  "\x50\x04\x41\x50\x50\x31\x87\x01\x01\x9F\x38"
				 "\x0A\xD1\x02\x9F\x66\x04\x9F\x2A\x08\x6F\x23",
									    33))
				chk->pass_criteria_met = false;
			chk->pass_criteria_checked = true;
	...
	case pc_2ed_001_01_case05:
		if (chk->state == 2) {
			if (!check_value(chk, data, EMV_ID_KERNEL_IDENTIFIER,
								   "\x24", 1) ||
			    !check_value(chk, data, EMV_ID_FCI_TEMPLATE,
				  "\x84\x08\xA0\x00\x00\x00\x04\x00\x04\x04\xA5"
				  "\x16\x50\x04\x41\x50\x50\x34\x87\x01\x01\x9F"
				  "\x38\x0A\xD1\x02\x9F\x66\x04\x9F\x2A\x08\x6F"
								    "\x24", 34))
				chk->pass_criteria_met = false;
			chk->pass_criteria_checked = true;
		}
	...
	case pc_2ed_002_00:
		if (chk->state == 2) {
			if (!check_value(chk, data, EMV_ID_KERNEL_IDENTIFIER,
								   "\x24", 1) ||
			    !check_value(chk, data, EMV_ID_FCI_TEMPLATE,
				  "\x84\x07\xA0\x00\x00\x00\x02\x00\x02\xA5\x16"
				  "\x50\x04\x41\x50\x50\x32\x87\x01\x01\x9F\x38"
				 "\x0A\xD1\x02\x9F\x66\x04\x9F\x2A\x08\x6F\x23",
									    33))
				chk->pass_criteria_met = false;
			chk->pass_criteria_checked = true;
	...
	case pc_2ee_001_00_case01:
		if (!check_value(chk, data, EMV_ID_FCI_TEMPLATE,
			  "\x84\x07\xA0\x00\x00\x00\x03\x00\x03\xA5\x81\xEF\x50"
			  "\x04\x41\x50\x50\x33\x87\x01\x01\x9F\x38\x03\x6F\x81"
			  "\xFB\xBF\x0C\x81\xDC\x5F\x50\x81\xD8\x68\x74\x74\x70"
			  "\x3A\x2F\x2F\x61\x61\x61\x61\x61\x2E\x61\x61\x61\x61"
			  "\x61\x2E\x61\x61\x61\x61\x61\x2E\x61\x61\x61\x61\x61"
			  "\x2E\x61\x61\x61\x61\x61\x2E\x61\x61\x61\x61\x61\x2E"
			  "\x61\x61\x61\x61\x61\x2E\x61\x61\x61\x61\x61\x2E\x61"
			  "\x61\x61\x61\x61\x2E\x61\x61\x61\x61\x61\x2E\x61\x61"
			  "\x61\x61\x61\x2E\x61\x61\x61\x61\x61\x2E\x61\x61\x61"
			  "\x61\x61\x2E\x61\x61\x61\x61\x61\x2E\x61\x61\x61\x61"
			  "\x61\x2E\x61\x61\x61\x61\x61\x2E\x61\x61\x61\x61\x61"
			  "\x2E\x61\x61\x61\x61\x61\x2E\x61\x61\x61\x61\x61\x2E"
			  "\x61\x61\x61\x61\x61\x2E\x61\x61\x61\x61\x61\x2E\x61"
			  "\x61\x61\x61\x61\x2E\x61\x61\x61\x61\x61\x2E\x61\x61"
	...
	case pc_2ee_001_00_case02:
		if (!check_value(chk, data, EMV_ID_SELECT_RESPONSE_SW,
							       "\x90\x00", 2) ||
		    !check_value(chk, data, EMV_ID_FCI_TEMPLATE,
			  "\x84\x07\xA0\x00\x00\x00\x03\x00\x03\xA5\x81\xEF\x50"
			  "\x04\x41\x50\x50\x33\x87\x01\x01\x9F\x38\x05\xD3\x02"
			  "\x6F\x81\xFB\xBF\x0C\x81\xDA\x5F\x50\x81\xD6\x68\x74"
			  "\x74\x70\x3A\x2F\x2F\x61\x61\x61\x61\x61\x2E\x61\x61"
			  "\x61\x61\x61\x2E\x61\x61\x61\x61\x61\x2E\x61\x61\x61"
			  "\x61\x61\x2E\x61\x61\x61\x61\x61\x2E\x61\x61\x61\x61"
			  "\x61\x2E\x61\x61\x61\x61\x61\x2E\x61\x61\x61\x61\x61"
			  "\x2E\x61\x61\x61\x61\x61\x2E\x61\x61\x61\x61\x61\x2E"
